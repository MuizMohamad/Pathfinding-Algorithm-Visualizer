...
class Visualizer:
    ...
    def widget_init(self):
        ...
        self.button_frame = tk.Frame(self.window,height = 650, width = 280, highlightthickness = 5, bg = '#6D4700', highlightbackground= '#5B3B00')
        self.button_frame.grid(column = 2 , row = 1 ,padx = 20)
        self.button_frame.grid_propagate(0)
        
        # Text Size
        self.sizeTxt = tk.Label(self.button_frame, text = 'Size' , bg = '#FFDFA4' ,font = "Arial 25 bold", width = 11 , highlightthickness = 5)
        self.sizeTxt.grid(column = 0 , row = 0, ipady = 10, padx = 0 , pady = (10,10))

        # Size text box and entry
        ...
        # Apply size and Clear maze buton
        ...
        self.createPathButton.grid(column = 1 , row = 0, padx = (10,0) , pady = 10)
         ...
         # Speed text
        self.speedTxt = tk.Label(self.button_frame, text = 'Speed' , bg = '#FFDFA4' ,font = "Arial 25 bold", width = 11 , highlightthickness = 5)
        self.speedTxt.grid(column = 0 , row = 6, ipady = 10, padx = 0 , pady = (10,10))  

        # Speed slider
        self.speedFrame = tk.Frame(self.button_frame,height = 50, width = 270 , bg ='#c203fc')
        self.speedFrame.grid_propagate(0)
        self.speedFrame.grid(column = 0 , row = 7, pady = (0,0), padx = 0, ipadx = 0, ipady = 0)

        self.speedScale = tk.Scale(self.speedFrame, from_ = 0.5, to = 2.0, length = 200,width = 10, resolution = 0.1,orient = HORIZONTAL)
        self.speedScale.grid(column=0,row=0, padx = (35,35), pady = (5,5) )
